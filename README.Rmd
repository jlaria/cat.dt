...
`r badger::badge_cran_release("cat.dt", "orange")`
`r badger::badge_cran_download("cat.dt", "grand-total", "blue")`
`r badger::badge_cran_download("cat.dt", "last-month", "green")`
`r badger::badge_cran_download("cat.dt", "last-week", "yellow")`
`r badger::badge_doi("10.1016/j.eswa.2019.113066", "yellow")`
